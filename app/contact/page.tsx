    ...
    <div className="min-h-screen bg-dark text-white px-6 py-24">
      <section className="max-w-5xl mx-auto grid gap-12 lg:grid-cols-[1.2fr_1fr]">
        <div className="space-y-8">
          ...
          <form
            className="space-y-4 bg-black/75 border border-neonBlue/30 rounded-3xl p-8 shadow-neon"
            name="guestlist-form"
            data-netlify="true"
            method="post"
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <label className="flex flex-col gap-2 text-sm uppercase tracking-[0.25em] text-gray-400">
                ...
                <input
                  ...
                  type="text"
                  name="name"
                  className="rounded-lg border-2 border-neonBlue/40 bg-black px-4 py-3 text-white focus:border-neonPink focus:outline-none transition-colors"
                />
              </label>
              <label className="flex flex-col gap-2 text-sm uppercase tracking-[0.25em] text-gray-400">
                Email
        ...
        <aside className="space-y-8 bg-black/70 border border-neonBlue/30 rounded-3xl p-8 shadow-neon">
          <div className="space-y-2">
            <h2 className="text-2xl font-serif text-neonPink">Direct Line</h2>
            <p className="text-sm text-gray-300 leading-relaxed">
              {contact.address}
            </p>
            <p className="text-sm text-gray-300">Email: <a href={`mailto:${contact.email}`} className="text-neonBlue hover:text-neonPink transition-colors">{contact.email}</a></p>
            <p className="text-sm text-gray-300">Phone: <a href={`tel:${contact.phone}`} className="text-neonBlue hover:text-neonPink transition-colors">{contact.phone}</a></p>
          </div>

          <div className="space-y-3">
            <h3 className="text-lg font-serif text-neonBlue uppercase tracking-[0.3em]">
              Connect
            </h3>
          ...
          <div className="space-y-3 text-sm text-gray-400">
            <p className="uppercase tracking-[0.3em] text-neonBlue">Why join?</p>
